...
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Мы собрали в одном месте опытных и креативных педагогов.';
...
<section id="exams" class="exams">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="d-none d-md-block col-lg-12 col-xl-5 offset-xl-1">
				<div class="animate__animated exams-child"></div>
			</div>
		</div>
	</div>
</section>
...
<!---Top sckool--->
<section id="top-sckool" class="top-sckool">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-lg-4">
				<div class="animate__animated opportunity">
					<div class="opportunity__list">
						<img src="img/school_icon_1.png" alt="" class="opportunity__icon">
			...
			<div class="col-md-6 col-lg-4">
				<div class="animate__animated opportunity">
					<div class="opportunity__list">
						<img src="img/school_icon_2.png" alt="" class="opportunity__icon">
			...
			<div class="col-md-6 col-lg-4">
				<div class="animate__animated opportunity">
					<div class="opportunity__list">
						<img src="img/school_icon_3.png" alt="" class="opportunity__icon">
						<h6 class="animate__animated opportunity__title">
							Иностранный язык
						</h6>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="animate__animated opportunity">
					<div class="opportunity__list">
						<img src="img/school_icon_4.png" alt="" class="opportunity__icon">
						<h6 class="animate__animated opportunity__title">
							Путешествия
						</h6>
					</div>
	...
	<div class="container-fluid">
		<div class="row no-gutters">
			<div class="d-none d-lg-block col-lg-7">
				<div class="animate__animated ticket-bg"></div>
			</div>
			<div class="col-lg-5">
			...
			<div class="d-lg-none col-lg-7">
				<div class="animate__animated ticket-bg-mob"></div>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-lg-4">
				<div class="photo-act">
					<div class="scale">
						<img src="img/activity_img_1.jpg" alt="">
					</div>
					<a href="#" class="photo-act__title photo-act__title1">
						Открытие детского лагеря
					</a>
					<p class="photo-act__text">
						<i class="far fa-clock"></i>
						01.06.2020 09:00
					</p>
					<div class="photo-act__date photo-act__date1">
						01.06
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4">
				<div class="photo-act">
					<div class="scale">
						<img src="img/activity_img_2.jpg" alt="">
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="photo-act">
					<div class="scale">
						<img src="img/activity_img_3.jpg" alt="">
					</div>
