<?php $title = 'Стоимость обучения - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Программа обучения включает в себя 16 авторских курсов для детей.';
