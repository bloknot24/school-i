<?php $title = 'Стоимость обучения - Первый Я';
$description = '«Первый Я» - это Частная школа и Центр дополнительного образования. Программа обучения включает в себя 16 авторских курсов для детей.';
