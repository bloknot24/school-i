        ...
        <div class="row">
            <div class="col-12">
                <div style="margin: 20px 0px 30px 0px; font-size: 18px;">
                    ...
                    <p>
                        <b>Мы стремимся</b> создавать пространство, где разные поколения могут активно общаться и <b>вместе делать добрые дела</b>.
                    </p>
                    <p>
                        Мы <b>объединяем детей</b>, родителей, педагогов и наставников, чтобы они вместе, как настоящие соавторы, <b>участвовали</b> во всех наших мероприятиях и проектах.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="private-school__benefits-head text-center">
                    ...
                    <p class="private-school__benefits-head-text">
                        Вашему ребёнку будет интересно
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="private-school__benefits-box">
                    ...
                    <p class="private-school__benefits-box-text">
                        Гармоничное развитие<br> ребёнка
                    </p>
                </div>
                <div class="private-school__benefits-box">
        ...
        <div class="row">
            <div class="col-12">
                <div class="private-school__benefits-link text-center">
                    <a href="#try-it" class="private-school__benefits-box-link-text">
                        Присоединяйтесь!
                    </a>
                </div>
            </div>
