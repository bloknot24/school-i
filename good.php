<?php $title = 'Мастерская добрых дел - Первый Я';
$description = 'Человеческая доброта, милосердие, умение радоваться и переживать за других людей создают основу человеческого счастья.';
