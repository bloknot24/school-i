<?php $title = 'Условия приёма - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Условия приема делятся на три этапа: тест - собеседование - оплата.';
