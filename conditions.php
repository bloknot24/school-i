<?php $title = 'Условия приёма - Первый Я';
$description = '«Первый Я» - это Частная школа и Центр дополнительного образования. Условия приема делятся на три этапа: тест - собеседование - оплата.';
