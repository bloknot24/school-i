<?php $title = 'Программы обучения - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Индивидуальный подход и уникальный план развития для каждого.';
