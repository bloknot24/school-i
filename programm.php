<?php $title = 'Программы обучения - Первый Я';
$description = '«Первый Я» - это Частная школа и Центр дополнительного образования. Индивидуальный подход и уникальный план развития для каждого.';
