<?php $title = 'Новости - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. События, которые мы организовываем и проводим.';
