<?php $title = 'Миссия - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Наша миссия - это образовательная среда развития личности ребенка.';
