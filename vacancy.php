	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-7">
				...
				<p class="earnings__text">
					Мы в школе нового формата «Новашкола Я» работу со смыслом, которая поменяет твою жизнь и жизнь общества вокруг тебя. Ты сможешь работать, обучать, вдохновлять и открывать новые возможности детям, живущим в разных странах.
				</p>
				<p class="earnings__text">
					<strong>
