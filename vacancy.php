<?php $title = 'Вакансии - НоваШкола Я';
$description = 'НоваШкола Я - это Частная школа и Центр дополнительного образования. Зарабатывать, занимаясь любимым делом, – это мечта многих. Наши вакансии.';
		...
		<div class="row">
			<div class="col-lg-7">
				...
				<p class="earnings__text">
					С нами <strong>Вы сможете реализовать свою мечту.</strong> Мы в «НоваШкола Я» предлагаем работу со смыслом, которая поменяет твою жизнь и жизнь общества вокруг тебя. Ты сможешь работать, обучать, вдохновлять и открывать новые возможности детям, живущим в разных странах.
				</p>
				<p class="earnings__text">
				...
				<p class="earnings__text">
					Мы в «Новашкола Я» предлагаем работу со смыслом, которая поменяет твою жизнь и жизнь общества вокруг тебя. Ты сможешь работать, обучать, вдохновлять и открывать новые возможности детям, живущим в разных странах.
				</p>
				<p class="earnings__text">
					<strong>
