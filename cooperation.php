<?php $title = 'Сотрудничество - Первый Я';
$description = '«Первый Я» - это Частная школа и Центр дополнительного образования. Международное сотрудничество - одно из основных направлений нашей работы.';
